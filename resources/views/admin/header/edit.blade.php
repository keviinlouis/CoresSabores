                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header" data-background-color="red">
                            <h4 class="title">Editar Header</h4>
                        </div>
                        <div class="card-content">
                            ...
                            @endif
                            {{Form::open(['route' => ['updateHeader', $header->id], 'method' => 'post', 'files' => true])}}
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group label-floating">
                                        ...
                                        {{Form::checkbox(
                                            'is_active', 1, $header->is_active==1?true:null,
                                            [
                                                'class' => 'form-control'
                                            ]
                                        )}}
                            ...
                            <div class="row">
                                <div class="col-md-12" >
                                    <div class="form-group dropzone" style="border:2px dashed #9c27b0" >
                                        ...
                                        {{Form::label('', 'Não insira nenhuma imagem caso não queira que a image mude')}}
